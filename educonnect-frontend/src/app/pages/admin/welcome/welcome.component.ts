...
export class WelcomeComponent implements OnInit{
  ...
  constructor(private toastr: ToastrService, private auth:AuthService,public dialog: MatDialog){
  ...
  openDialog(id: any,userName:any,firstName:any,lastName:any,email:any,phone:any,status:any) {
